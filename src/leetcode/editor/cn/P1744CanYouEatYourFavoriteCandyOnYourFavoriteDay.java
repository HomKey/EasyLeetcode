...
//Java：你能在你最喜欢的那天吃到你最喜欢的糖果吗？
public class P1744CanYouEatYourFavoriteCandyOnYourFavoriteDay{
    public static void main(String[] args) {
        Solution solution = new P1744CanYouEatYourFavoriteCandyOnYourFavoriteDay().new Solution();
        // TO TEST
    }
